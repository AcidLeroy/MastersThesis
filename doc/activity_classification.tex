...
The data used for this thesis is a subset of the entire AOLME dataset. By hand,
we have selected a few videos and extracted typing and writing clips from
the original dataset and are using these as ground truth.
