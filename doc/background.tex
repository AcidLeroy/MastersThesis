...
all the datasets study consist of hardware augmentation (a motion tracking glob
for example), used to track motions of hands etc, and do not rely solely on the
...
classification \cite{karpathy2014large}. This technique has much promise, but is
extremely time consuming to train, it took nearly one month of training in
