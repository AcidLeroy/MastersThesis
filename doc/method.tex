...
vector machines (SVM). Finally, we cover the details of distributing this system
over an elastic cloud architecture for scalability and flexibility using Amazon
Web Services (AWS).
...
and \\
\texttt{calcOpticalFlowPyrLK}. The first function is used to find features
