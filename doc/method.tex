...
it is ready to run. Figure \ref{fig:continuous_integration} demonstrates the
...
\begin{figure}[h]
  ...
  \caption{Automated deployment of ViDA to the AWS cloud using continous integration}
\end{figure}
