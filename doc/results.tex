...
The input messages into the cluster are shown in Table \ref{tab:message_queue}.
...
\section{Discussion}
 ...
 as illustrated in Figure \ref{size_matters}. Furthermore, since the convolutions
